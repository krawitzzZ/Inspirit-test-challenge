define(function (require) {
    describe('Ajax API', function () {
        ...
        it('postResponse() return promise with server response and methods done, fail and always', function () {
        ...
        it('responseCodes() return promise with server response and methods done, fail and always', function () {
        ...
        it('dataSet() return promise with server response and methods done, fail and always', function () {
